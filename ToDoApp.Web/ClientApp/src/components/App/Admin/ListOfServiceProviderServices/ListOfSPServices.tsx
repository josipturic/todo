...
const AdminServiceProviderServices: React.FC<IProps> = (props: IProps) => {
  ...
  const OpenService = (serviceId: string) => {
    ...
    props.history.push(CLIENT.APP.ADMIN.SERVICE_WITH_ID(serviceId));
  };
...
export default AdminServiceProviderServices;
